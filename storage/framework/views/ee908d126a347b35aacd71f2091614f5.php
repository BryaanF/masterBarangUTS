...
unset($__errorArgs, $__bag); ?>" type="text"
                            name="name" id="name" value="<?php echo e(old('name')); ?>" placeholder="Enter the name">
...
unset($__errorArgs, $__bag); ?>" type="number"
                            name="price" id="price" value="<?php echo e(old('price')); ?>" placeholder="Enter the price">
...
unset($__errorArgs, $__bag); ?>"
                            type="text" name="description" id="description" value="<?php echo e(old('description')); ?>"
...
<?php /**PATH C:\Users\Muhamad Brilliant\masterBarangUts\resources\views/items/input.blade.php ENDPATH**/ ?>